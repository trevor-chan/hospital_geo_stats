...
PHILADELPHIA COUNTY HOSPITAL PERFORMANCE AND HEALTH INSURANCE COVERAGE VISUALIZED
...
// function _json()
// {
//     json = d3.json("jsons/tl_2020_42_tract_simple.json")
// }

function _chart(d3,legend,topojson,us,color,data,path,format)
{
//   var json = d3.json("jsons/tl_2020_42_tract_simple.json")
...
//   svg.append("path") //State borders outlined in white
...
FileAttachment("./jsons/tl_2020_42_tract_simple.json").json()
)}

export default function define(runtime, observer) {
  const main = runtime.module();
  const fileAttachments = new Map([["./jsons/tl_2020_42_tract_simple.json",new URL("./jsons/tl_2020_42_tract_simple.json",import.meta.url)],["cdc-diabetes-obesity.csv",new URL("./files/a532a3a211eb0a93bc9f24f5a1915f4689b36e46a99a8c3df3692cd9a26670a9b7c05aaee62ce583f4237797a1d489cc0f0c46549200744a0a5996417093a05c",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("viewof colors")).define("viewof colors", ["Inputs","schemes"], _colors);
//   main.variable(observer("json")).define("json", _json);
  main.variable(observer("colors")).define("colors", ["Generators", "viewof colors"], (G, _) => G.input(_));
  main.variable(observer("chart")).define("chart", ["d3","legend","topojson","us","color","data","path","format"], _chart);
